    ...
    "paths": {
        ...
        "/host/me": {
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Host profile updates",
                        "name": "host",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Updated Host profile",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
