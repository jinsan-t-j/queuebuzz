...
func (m *Module) RegisterRoutes(router fiber.Router) {
	...
	router.Get("/auth/social/:provider/start", m.Handler.SocialLogin)
	router.Get("/auth/social/:provider/callback", m.Handler.SocialCallback)
	router.Post("/auth/social/:provider/callback", m.Handler.SocialCallback)
}
